...
export default function ConventionModal(): JSX.Element {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
            ...
            <div
                className={`relative z-10 w-full max-w-2xl overflow-hidden rounded-2xl border border-[#D5BC7A]/45 bg-[#FCF7EF] text-black shadow-2xl transition-all duration-200 max-h-[92vh] sm:max-h-[95vh] ${
            ...
            >
                ...
                <img
                    ...
                    className="max-h-[52vh] w-full object-contain bg-black sm:max-h-[65vh]"
                />

                <div className="space-y-3 p-4 sm:space-y-4 sm:p-6">
                    <h2 id="convention-modal-title" className="text-lg font-semibold tracking-tight text-[#191400] sm:text-2xl">
                        La convention JFCI approche
                    </h2>
                    <p className="text-sm text-[#3D3323] sm:text-base">
                    ...
                    <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-3">
                        <Link
                            href="/inscription"
                            className="inline-flex items-center justify-center rounded-xl bg-[#C9A24A] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(0,0,0,0.18)] transition hover:bg-[#B68E3A] sm:px-5 sm:py-3"
                        >
                        ...
                        <button
                            type="button"
                            onClick={closeModal}
                            className="inline-flex items-center justify-center rounded-xl border border-[#1C1C1A]/20 px-4 py-2.5 text-sm font-medium text-[#1C1C1A] transition hover:bg-white sm:px-5 sm:py-3"
                        >
                            Fermer
                        </button>
                    </div>
